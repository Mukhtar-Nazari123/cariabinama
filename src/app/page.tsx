...
const testimonials = [
  ...
  {
    name: 'الهه احمدی',
    job: 'مدیر منابع انسانی',
    avatar: 'https://i.pravatar.cc/150?u=elaheh',
    rating: 5,
    comment: "به‌عنوان یک مدیر منابع انسانی، از کیفیت کارجویانی که از طریق این پلتفرم پیدا کرده‌ایم بسیار راضی هستم.",
  },
  {
    name: 'بابک نوری',
    job: 'توسعه‌دهنده اندروید',
    avatar: 'https://i.pravatar.cc/150?u=babak',
    rating: 4,
    comment: "تنوع آگهی‌های شغلی برای توسعه‌دهندگان موبایل خوب است. توانستم چند موقعیت عالی پیدا کنم.",
  },
  {
    name: 'شبنم ریاحی',
    job: 'کارشناس سئو',
    ...
    rating: 5,
    comment: "با استفاده از کاریابی نما، توانستم در یک آژانس دیجیتال مارکتینگ معتبر استخدام شوم. فرآیند شفاف و ساده بود.",
  },
  {
    name: 'مهدی یوسفی',
    ...
    rating: 4,
    comment: "برای پیدا کردن دوره کارآموزی خیلی به من کمک کرد. شرکت‌های خوبی در این سایت آگهی کارآموزی می‌گذارند.",
  },
  {
    name: 'پریسا جواهری',
    job: 'وکیل',
    avatar: 'https://i.pravatar.cc/150?u=parisa',
    rating: 5,
    comment: "فکر نمی‌کردم برای رشته‌های حقوقی هم آگهی داشته باشد، اما یک موقعیت عالی در یک شرکت بزرگ پیدا کردم.",
  },
  {
    name: 'سینا شریفی',
    job: 'طراح صنعتی',
    avatar: 'https://i.pravatar.cc/150?u=sina',
    rating: 5,
    comment: "پورتفولیو و رزومه من به خوبی دیده شد و توانستم با کارفرماهای مختلفی ارتباط بگیرم. تجربه فوق‌العاده‌ای بود.",
  },
  {
    name: 'رویا عزیزی',
    job: 'معلم زبان انگلیسی',
    avatar: 'https://i.pravatar.cc/150?u=roya',
    rating: 4,
    comment: "آگهی‌های آموزشگاه‌های زبان بسیار متنوع بود و به راحتی شغل پاره‌وقت مورد نظرم را پیدا کردم.",
  },
  {
    name: 'ایمان کریمی',
    job: 'مهندس برق',
    ...
    rating: 5,
    comment: "از طریق هشدارهای شغلی، یک موقعیت تخصصی در حوزه کاری خودم پیدا کردم که در سایت‌های دیگر ندیده بودم.",
  },
  {
    name: 'گلناز افشار',
    job: 'روزنامه‌نگار',
    avatar: 'https://i.pravatar.cc/150?u=golnaz',
    rating: 4,
    comment: "تنوع آگهی‌ها برای مشاغل حوزه رسانه و محتوا قابل قبول است. امیدوارم در آینده بیشتر هم بشود.",
  },
  {
    name: 'سهیل رسولی',
    job: 'مدیر فروش',
    avatar: 'https://i.pravatar.cc/150?u=soheil',
    rating: 5,
    comment: "تیم پشتیبانی بسیار پاسخگو و حرفه‌ای بود. در یکی از مراحل به مشکل خوردم که به سرعت حل شد. ممنون از شما.",
  }
];
